...
class Filters extends BaseFilters
{
    ...
    public array $globals = [
        'before' => [
            ...
            // 'csrf',
            // 'invalidchars',
            'session' => ['except' => ['/', 'login*', 'register', 'auth/a/*', 'auth/google', 'auth/google/*', 'logout', 'tournaments/shared/*', 'tournaments/*/view', 'tournaments/create',  'api/*', 'gallery', 'gallery/*', 'participants', 'participants/*', 'contact', 'terms']],
